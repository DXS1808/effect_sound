...
import static com.reactlibrary.un4seen.bass.BASS.BASS_CONFIG_FLOAT;
...
import com.voicechanger.supereffect.soundeffect.ui.base.BaseCallback;
...
//    }
    ...
    public void saveEffect(int effectIndex, String effectName, BaseCallback callback) {
...
//                showToast("File not found exception");
    ...
    public void onSaveEffect(final EffectObject mEffectObject, String effectName, BaseCallback callback) {
        if (mDBMedia != null) {
            //onResetState();
        }
        if (mDBMedia != null) {
...
//                    WritableMap params = Arguments.createMap();
    ...
    private File getDir() {
        String dirpath = Environment.getExternalStorageDirectory().getPath() + "/" + Environment.DIRECTORY_DOWNLOADS + "/" + "VoiceEffects";
